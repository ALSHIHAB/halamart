            ...
            <div class="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-gray-800 shadow">
                ...
                <div class="flex flex-1 justify-end px-4">
                    <div
                        ...
                        <a class="{{ app()->getLocale() == 'ar' ? 'underline text-white underline-offset-1' : '' }} flex px-1 hover:font-semibold hover:text-yellow-200"
                ...
                <div class="py-6">
                    ...
                    <section class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                        ...
                        <div class="py-4 px-4">
                            ...
                            <p class="pt-4">Welcome to Halamart documentation!</p>

                            <p> This page will guide you step by step to install and set up an online store
                                with the Halamart platform. You will also learn how to manage your store with the
                                admin dashboard.</p>

                            <p>If you have any diffeculties please do not hesitate to email us via support@halamart.biz,
                        ...
                        <div id="requirement" class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                            ...
                            <p>Halamart is an e-commerce platform built on top of the Laravel framework which has a few
                        ...
                        <div id="installation" class="mx-auto mt-10 max-w-7xl px-4 sm:px-6 md:px-8">
                            ...
                            <ul class="list-disc space-y-2 px-4">
                                <li>
                                    <strong>Download and unzip halamart file</strong>
                                ...
                                <li>
                                    ...
                                    <p>By default, Halamart use local drive to store its files in storage/app/public. To
                                ...
                                <li>
                                    ...
                                    <p>Use any of your Mysql management software or phpMyadmin to create a new database
                                        for Halamart with utf8mb4 charset encoding and utf8mb4_unicode_ci collection.
                                    ...
                                    <div class="flex w-full justify-start">
                                        <code class="w-full rounded-md border border-gray-400 p-2">
                                            <span class="text-sm font-normal text-blue-900">
                                                ...
                                                <p>email: admin@halamart.biz</p>
                                                <p>password: halamart</p>
                                            </span>
                                        </code>
                                    </div>
                                    ...
                                    <div class="flex w-full justify-start">
                                        <code class="w-full rounded-md border border-gray-400 p-2">
                                            <span class="text-sm font-normal text-blue-900">
                                                ...
                                                <p>email: customer@halamart.biz</p>
                                                <p>password: halamart</p>
                                            </span>
                                        </code>
                                    </div>
                        ...
                        <div id="config" class="mx-auto mt-10 max-w-7xl px-4 sm:px-6 md:px-8">
                            ...
                            <ul class="list-disc space-y-2 px-4">
                                <li>
                                    ...
                                    <p>
                                        By default English (en) and Arabic (ar) are used in Halamart platform. However,
                        ...
                        <div id="support" class="mx-auto mt-10 max-w-7xl px-4 sm:px-6 md:px-8">
                            ...
                            For support, you can email us via: <strong>support@halamart.biz</strong>
                        </div>
                    </section>
                    ...
                    <section class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                        ...
                        <div id="blog-posts" class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                            ...
                            <p> Company news are important for eCommerce website. Therefore, Halamart has a very good
                        ...
                        <div id="devlopers" class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                            ...
                            <p>Halamart platform is a good starting point for eCommerce websites with laravel,
