<x-guest-layout>
    <div class="bg-gray-100">
        <div class="px-4 py-16 mx-auto max-w-7xl sm:py-24 sm:px-6 lg:px-8">
            ...
            <div class="relative bg-white shadow-xl">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3">
                    <!-- Contact information -->
                    <div class="relative px-6 py-10 overflow-hidden bg-sky-700 sm:px-10 xl:p-12">
                        ...
                        <div class="flex mt-6">
                            ...
                            <p class="rtl:mr-3 ltr:ml-3 text-base text-indigo-50 flex">
                        ...
                        <dl class="mt-8 space-y-6">
                            ...
                            <dd class="flex text-base text-indigo-50">
                                ...
                                <span class="rtl:mr-3 ltr:ml-3">{{ config('global.contact') }}</span>
                            </dd>
                            ...
                            <dd class="flex text-base text-indigo-50">
                                ...
                                <span class="rtl:mr-3 ltr:ml-3">{{ config('global.email') }}</span>
                            </dd>
                        </dl>
                        <div class="flex mt-8 space-x-6 rtl:space-x-reverse">
        ...
        <x-home.branches />
        <iframe class="pt-10 w-full h-[500px]"
            src="https://maps.google.com/maps?q=amestrdam&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0"
