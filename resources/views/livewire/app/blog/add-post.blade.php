            ...
            <div class="mt-6 lg:col-span-2">
                <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div>
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <textarea type="text" wire:model.defer="title_ar" {{ $readOnly ? 'disabled' : '' }} dir="rtl" required
                                    class="block w-full border-gray-300 rounded-md peer read-only:bg-gray-100 placeholder:text-gray-400 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    placeholder="{{ __('Title') }}" aria-describedby="title_ar">
                                </textarea>
                            </div>
                        </div>
                        @error('title_ar')
                    ...
                    <div class="sm:col-span-2">
                        <div wire:ignore>
                            {{-- <div class="flex justify-between"> --}}
                            <label for="content_ar" class="block text-sm font-medium text-gray-900">
                                {{ __('Content') }} {{ __('Arabic') }}
                            </label>
                            {{-- <p class="text-xs text-gray-500 peer-optional:hidden">{{ __('Required') }}</p> --}}
                            {{-- </div> --}}
                            <div class="mt-1">
                                <textarea x-data x-ref='ckEditor' x-init="ClassicEditor
                                    .create($refs.ckEditor, {
                                        ...
                                        editor.model.document.on('change:data', () => {
                                            @this.set('content_ar', editor.getData());
                                        });
                                    })
                                    .catch(error => {
                                
                                    });" wire:model='content_ar' class="resize-none form-control"
                                    rows="10">
                            </textarea>
                            </div>
                        </div>
                    ...
                    <div x-cloak class="sm:col-span-2" x-data="{ content: '', limit: $el.dataset.limit }" data-limit="255">
                        <div class="flex justify-between">
                            <label for="excerpt_ar" class="block text-sm font-medium text-gray-700">
                                {{ __('Excerpt') }} {{ __('Arabic') }}
                                <span class="text-xs text-gray-500">
                                    ({{ __('Max. 255 characters') }})
                                </span>
                            </label>
                        ...
                        <div>
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <textarea ref="content" x-model="content" dir="rtl" x-bind:maxlength="limit" rows="3"
                                    wire:model.defer="excerpt_ar" {{ $readOnly ? 'disabled' : '' }}
                                    class="block w-full border-gray-300 rounded-md peer read-only:bg-gray-100 placeholder:text-gray-400 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    placeholder="{{ __('Short description') }}" aria-describedby="excerpt_ar">
                                </textarea>
                            </div>
