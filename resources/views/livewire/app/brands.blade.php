                    ...
                    <div
                        ...
                        <div class="px-4 pt-5 pb-4 ltr:text-left rtl:text-right sm:p-6">
                            <div>
                                ...
                                <div class="mt-4">
                                    <label for="name_ar"
                                        class="block text-sm font-medium text-gray-700">{{ __('Name') }}&nbsp;{{ __('Name Arabic') }}</label>
                                    <div class="relative mt-1 rounded-md shadow-sm">
                                ...
                                <div class="mt-4">
                                    <div class="flex justify-between">
                                        <label for="description_ar" class="block text-sm font-medium text-gray-900">
                                            {{ __('Description') }} {{ __('Arabic') }}
                                        </label>
                                        <span id="description_ar-max"
                                            class="text-xs text-gray-500">{{ __('Max. 255 characters') }}</span>
                                    </div>
                                    <div class="relative mt-1 rounded-md shadow-sm">
                                        <textarea rows="4" wire:model.defer="description_ar" {{ $readOnly ? 'disabled' : '' }}
                                            class="block w-full border-gray-300 rounded-md peer read-only:bg-gray-100 placeholder:text-gray-400 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                            placeholder="الوصف بالعربي" aria-describedby="description_ar">
                                        </textarea>
                                        <div
                                            class="absolute inset-y-0 flex items-center px-2 m-1 bg-gray-100 pointer-events-none peer-optional:hidden ltr:right-0 rtl:left-0">
                                            <span class="text-gray-500 sm:text-xs" id="description_ar">
                                                {{ __('Required') }}
                                            </span>
                                        </div>
                                    </div>
